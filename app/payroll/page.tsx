                      ...
                      <TableRow key={ps.id}>
                        ...
                        <TableCell className="text-right">
                          <Button variant="secondary" size="sm" asChild>
                            <Link
                              href={`/payslips?employee=${encodeURIComponent(ps.employee_id)}&period=${encodeURIComponent(selectedRun.cutoff_start)}&payroll_run_id=${encodeURIComponent(selectedRun.id)}`}
                            >
