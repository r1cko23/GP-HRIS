...
While biometric is rolling out, phone GPS bundy still works for mapped staff.
A biometric punch on a day that already has a phone bundy row replaces that IN
(and the OUT follows the terminal). Portal bundy cutover for mapped people is separate.
