...
-- Description:	<Process Aldex billing Data>
-- =============================================
CREATE PROCEDURE [dbo].[BILLINGGENERATETEMPLATE1ALDEX]
...
, BILLINGTABLE.dailyrate_billing as bdailyrate
