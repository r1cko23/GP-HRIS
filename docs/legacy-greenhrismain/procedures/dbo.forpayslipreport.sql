...
-- =============================================
CREATE PROCEDURE  [dbo].[forpayslipreport]
...
FROM            thirteenmonth INNER JOIN
                         ...
                         Department ON thirteenmonth.iddepartment = Department.iddepartment
WHERE        (thirteenmonth.idclient = @idclient) 
AND (thirteenmonth.iddepartment = @iddepartment) 
AND (thirteenmonth.thirteenmonthyear = @parayear)
and (thirteenmonth.paythrough Like +'%'+ @paythrough +'%')
