...
-- =============================================
CREATE PROCEDURE [dbo].[usp_employeebarredlist]
 @filtertext8 nvarchar(100)
...
WHERE Employee.finalpaystatus = 'Barred'
...
WHERE(
        ISNULL(@filtertext8, '') = ''
        OR fname LIKE '%' + @filtertext8 + '%'
        OR lname LIKE '%' + @filtertext8 + '%'
        OR mname LIKE '%' + @filtertext8 + '%'
        OR companyname LIKE '%' + @filtertext8 + '%'
        OR departmentname LIKE '%' + @filtertext8 + '%'
    )
