...
-- =============================================
CREATE PROCEDURE [dbo].[usp_employeeonleavelist]
  @filtertext4 varchar(100) 
...
where (
        ISNULL(@filtertext4, '') = ''
        OR fname LIKE '%' + @filtertext4 + '%'
        OR lname LIKE '%' + @filtertext4 + '%'
        OR mname LIKE '%' + @filtertext4 + '%'
        OR companyname LIKE '%' + @filtertext4 + '%'
        OR departmentname LIKE '%' + @filtertext4 + '%'
    );
