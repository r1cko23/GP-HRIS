-- Soften biometric rollout: allow phone GPS bundy again for mapped staff.
-- Biometric punches still replace same-day phone rows in applyAttlogPush.
-- Portal bundy access cutover comes later.
